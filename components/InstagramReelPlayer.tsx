  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom content area */}
        <div className="absolute bottom-24 sm:bottom-20 left-4 right-20 z-10 pb-2 max-h-[40vh] overflow-y-auto">
        ...
        <div className="absolute bottom-24 sm:bottom-20 right-4 flex flex-col items-center gap-5 z-10 pb-2">
          {/* Like Button */}
          {currentUserId && (
            <ReelLikeButton
              reelId={reel._id}
